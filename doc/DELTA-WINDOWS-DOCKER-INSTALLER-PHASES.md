...
**Status: COMPLETE** · 2026-08-21 · commits `8926bfa` + `7e80f73` · **Result: PASS.** 175 Phase 12 assertions and 351 regression assertions pass — 526 in total.
...
**2026-08-21, same day** · commit `e959802`. The primary-domain refusal was correct and stayed correct, but it was a dead end: an operator installing on `localhost` and then being handed a certificate for `delta.example.org` was told what was wrong and sent to a different menu to fix it. The refusal now comes with an offer.
